...
install: $(TARGET)
	cp ./dplayer ~/.local/bin; [ ! -d ~/.icons ] && mkdir ~/.icons; cp dplayer.png ~/.icons; [ ! -d ~/.local/share/applications ] && mkdir -p ~/.local/share/applications; cp dplayer.desktop ~/.local/share/applications
